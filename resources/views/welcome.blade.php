...
<div class="container mx-auto px-4 header">
    <div class="">
        <div class="flex items-center justify-between px-6 py-4 rounded rounded-lg border mt-4">
            <img class="w-32" src="Logo fessage.png" alt="Logo">
            <div class="flex items-center">
                <button
                    class="px-4 py-2 rounded-lg text-white hover:bg-blue-500  hover:text-white border border-blue-600"
                    onclick="location.href='{{ url('/register') }}'">Signup
                </button>
                <button
                    class="px-4 py-2 rounded-lg text-white hover:bg-blue-500  hover:text-white border border-blue-600 ml-4"
                    onclick="location.href='{{ url('/login') }}'">Login
                </button>
            </div>
        </div>
        <div class=" px-6 py-4 flex flex-col items-center rounded rounded-lg border mt-5">
            ...
            <button class="px-4 py-2 rounded-lg bg-teal-500 text-white hover:bg-blue-500  hover:text-white border border-blue-600"
                    onclick="location.href='{{ url('/register') }}'">Register Now
            </button>
        </div>
    </div>
    <div class=" rounded rounded-lg border mt-4">
    ...
    <div class=" rounded rounded-lg border mt-4 mb-4">
    <footer class="bg-gray-800 px-6 py-4 rounded rounded-lg mt-8">
        <div class="flex items-center justify-between rounded rounded-lg border p-4">
            <img class="w-32" src="./Images/footerLogo.svg" alt="Logo">
            <div class="flex items-center">
                <label for="footerbutton" class="text-white mr-4">Ready to get started?</label>
                <button id="footerbutton" class="px-4 py-2 rounded-lg bg-teal-500 text-white hover:bg-blue-500  hover:text-white border border-blue-600"
                        onclick="location.href='{{ url('/register') }}'">Get Started
                </button>
            </div>
        </div>
        <div class="flex mt-4 rounded rounded-lg border p-2">
            ...
            <div class="w-1/3 px-4 py-2 rounded rounded-lg border">
                ...
                <button class="px-4 py-2 mt-2 rounded-lg bg-teal-500 text-white hover:bg-blue-500  hover:text-white border border-blue-600">Subscribe</button>
            </div>
        </div>
        <div class="mt-4 text-center text-gray-500">
            Copyright 2021 Fessage
        </div>
    </footer>
    </div>
